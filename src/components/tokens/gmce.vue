<template>
    ...
    <div class = "content_token_page">
     ...
     <div class="row tokenPage" >
         <div class="column left" >
             ...
             <div id="gmce_logo"> </div>
          
         </div>
         <div class="column middle" style="background-color:#005a68;">
            <div class="separator" style = "color:#dbac04" id="gmce_separator"><a href=""><cryptoicon symbol="bnb" size="40" /></a> &nbsp;  &nbsp;<span id="text_title"></span></div>
           
             <p1 class = "desc" style = "color: white" id="gmce_desc" > </p1>
             <br><div  id="gmce_icons">
            <br > <a id='gmce_telegram' href=""><i class="fa fa-telegram" style="font-size:clamp(24px, 2vw, 40px);color:#DBAC04"></i> </a>
            <a id="gmce_whitepaper" href=""><i class="fa fa-file-text" style="font-size:clamp(24px, 2vw, 40px); color:#DBAC04"></i></a>
            <a id='gmce_twitter' href=""><i class="fa fa-twitter" style="font-size:clamp(26px, 2.32vw, 42px); color:#DBAC04"></i></a>
 
             <a id="gmce_site" href=""><i class="fa fa-chrome" style="font-size:clamp(24px, 2vw, 40px);color:#DBAC04"></i></a></div>
 ...
 <p style="color:white;" class = "table-text">Listing Date</p></th>
     <td><p style="color:white;" class = "table-text" id="gmce_listing"></p></td>
   </tr>
   <tr>
     <th><p style="color:white;" class = "table-text">Launch Date</p>	</th>
     <td><p style="color:white;" class = "table-text" id="gmce_launch"></p></td>
   </tr>
   <tr>
     <th><p style="color:white;" class = "table-text">Token Type</p></th>
     <td><p style="color:white;" class = "table-text" id="gmce_layer"></p></td>
   </tr>
   <tr>
     <th>
 <p style="color:white;" class = "table-text">Contract</p></th>
     <td><p style="color:white;" class = "table-text-link" >   <a id="gmce_contract" href="">BSC Scan</a></p></td>
   ...
   <div class="row_chart" >
         <div class="column left2" id="gmce_graph" >
              <TVChartContainer  :symbol="'BITQUERY'" :interval="'60'" :contractAddress="'0x9528cCEb678B90dAf02cA5cA45622D5cBaF58A30'"></TVChartContainer>
         </div>
 ...
 <table  class = 'token_price' style="width:100%">
   <tr>
     <th  style="color: white;" id="gmce_price"> </th>
 
    <td   style="color: white;"><p id="gmceiUSD"></p></td>
 
   </tr >
   <tr >
     <th  style="color: white;" id="gmce_bnb"></th>
     <td   style="color: white;"><p id="gmce/BNB"></p></td>
 
   </tr>
       <th  style="color: white;" id="gmce_mcap">Total MCAP </th>
 
    <td  style="color: white;"><p id="mcap_gmce"></p></td>
   <tr >
   <th style="color:white">Daily Change</th>
   
   <td style="color:white" ><p id="gmce_summary_val"></p></td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td ><p  id = "gmce_liq_val"></p></td>
 
   </tr>
    <tr>
     <th style="color: white;">ATH Price </th>
    <td ><p  id = "gmce_ath_price"></p></td>
 ...
 var contractaddress = "0x9528cCEb678B90dAf02cA5cA45622D5cBaF58A30";
     ...
     props: ["id"],
      data() { 
       ...
       return {
         ...
         utility:'L3' ,
         team:'Undoxxed',
         wallettAddressRating:'0xe7cf56a19b2e76dfbdd10a7cd953317ec9860e86',
         name: 'gmce Finance',
         symbol: 'gmce',
 ...
 document.getElementById('gmce_separator').href= bscscan
 document.getElementById('text_title').innerHTML= name
 document.getElementById('gmce_price').innerHTML = symbol
 document.getElementById('gmce_bnb').innerHTML = symbol+'/BNB'
 document.getElementById('gmce_desc').innerHTML = desc
 document.getElementById('gmce_launch').innerHTML = launch_date
 document.getElementById('gmce_layer').innerHTML = utility
 document.getElementById('gmce_listing').innerHTML = date
 document.getElementById('gmce_whitepaper').href = whitepaper
 document.getElementById('gmce_site').href = website
 document.getElementById('gmce_twitter').href = twitter
 document.getElementById('gmce_telegram').href = telegram
 document.getElementById('gmce_contract').href = bscscan
 
 var img = document.createElement("img");
 img.id='logo'
 img.src = logo_link_api;
 var src = document.getElementById("gmce_logo");
 src.appendChild(img);
 ...
 const acs = await axios.get(
                     ...
                     document.getElementById("gmce/BNB").innerHTML =acs_value
 ...
 if (TokenUS<0.01) { 
   ...
   function expo(x, f) {
    ...
    document.getElementById("gmceiUSD").innerHTML =    
  usd.bold()+ (expo(TokenUS, 2)) }
   
   else { document.getElementById("gmceiUSD").innerHTML =    
 ...
 document.getElementById("mcap_gmce").innerHTML =  usd.bold()+ mcap_form
 ...
 document.getElementById("gmce_liq_val").innerHTML = await usd.bold()+  liq_format
   ...
   var percent = "%"
     if (ath_usd<0.01){
         function expo(x, f) {
           ...
           document.getElementById("gmce_ath_price").innerHTML = await (usd.bold()+final_ath)
     }else{let final_ath= (    
 ...
 document.getElementById("gmce_summary_val").innerHTML = await percent_fixed
 if (percent_change<0){
    document.getElementById("gmce_summary_val").style.color = "#EA3943"
   ...
   document.getElementById("gmce_summary_val").innerHTML = "0"+percent
 }
 ...
 setTimeout(() => {
   ...
   var percent_change = document.getElementById('gmce_summary_val').innerHTML
