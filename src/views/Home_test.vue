...
<table class="token_table" id="table_home_test">
 ...
 <th><b><div class="dropdown" id="dropdown_color">
  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    <td class="icon_0_big" id="icon_4">  </td>
    <td >  <a id='link_4_name' href=""><p class='name' id="name_4">   &nbsp;</p></a> </td>
    <td class='price' Id="price_4">  </td>
    <td class="rating" id="rating_4" >  </td>
    <td class="mcap" id="MCAP_4" ></td>
    <td class="liquidity" id="liquidity_4"> </td>
    <td class="info" id="info_4"><span id="doxxed_4"></span><span id="kyc_4"></span> </td>
  </tr >
  <tr height="80px" class="Home_Page">
   
    <td class="icon_0_big" id="icon_3">  </td>
    <td >  <a id='link_3_name' href=""><p class='name' id="name_3">   &nbsp;</p></a> </td>
    <td class='price' Id="price_3">  </td>
    <td class="rating" id="rating_3" >  </td>
    <td class="mcap" id="MCAP_3" ></td>
    <td class="liquidity" id="liquidity_3"> </td>
    <td class="info" id="info_3"><span id="doxxed_3"></span><span id="kyc_3"></span> </td>
  </tr >

  <tr height="80px" class="Home_Page">
   
    <td class="icon_0_big" id="icon_2">  </td>
    <td >  <a id='link_2_name' href=""><p class='name' id="name_2">   &nbsp;</p></a> </td>
    <td class='price' Id="price_2">  </td>
    <td class="rating" id="rating_2" >  </td>
    <td class="mcap" id="MCAP_2" ></td>
    <td class="liquidity" id="liquidity_2"> </td>
    <td class="info" id="info_2"><span id="doxxed_2"></span><span id="kyc_2"></span> </td>
  </tr >
    <tr height="80px" class="Home_Page">
  ...
  <tr height="80px" class="Home_Page">
    ...
    <td class="liquidity" id="liquidity_0"> </td>
    <td class="info" id="info_0"> <i class='fa fa-id-card' style="font-size: 25px;color:#DBAC04"></i> <i class='fa fa-users' style='font-size: 25px;color:#DBAC04'></i></td>
  </tr >
...
var usd = '$'
document.getElementById('rating_0').innerHTML=rating
...
if (price<0.01) { 
  ...
  function expo(x, f) {
   ...
   document.getElementById("price_0").innerHTML =    
 usd.bold()+ (expo(price, 2)) }
  
  else { document.getElementById("price_0").innerHTML =    
...
document.getElementById("liquidity_0").innerHTML =  usd.bold()+  liq_format

var mcap_fixed = parseFloat(mcap).toFixed(0)
var mcap_form= form2.format(mcap_fixed)

document.getElementById("MCAP_0").innerHTML =  usd.bold()+ mcap_form
var progress_html = document.querySelector("#rating_0")
...
console.log(liquidity, price, logo, rating)
...
var mcap=data_response.mcap
 ...
 var form2 = Intl.NumberFormat('en-US')
var usd = '$'
document.getElementById('rating_1').innerHTML=rating
...
if (price<0.01) { 
 ...
 usd.bold()+ (expo(price, 2)) }
  ...
  else { document.getElementById("price_1").innerHTML =    
  usd.bold()+ form2.format(tokenUS_fixed)}
...
document.getElementById("liquidity_1").innerHTML =  usd.bold()+  liq_format

var mcap_fixed = parseFloat(mcap).toFixed(0)
var mcap_form= form2.format(mcap_fixed)

document.getElementById("MCAP_1").innerHTML =  usd.bold()+ mcap_form
var progress_html = document.querySelector("#rating_1")
console.log(progress_html)
if (rating>80){
  progress_html.style=`color:#036b18`
}
...
if (kyc==Verified){
 document.getElementById('kyc_2').innerHTML="<i class='fa fa-id-card' style='font-size: 25px;color:#DBAC04'></i>"
}
if (team ==doxxed){
...
var mcap=data_response.mcap
 ...
 var form2 = Intl.NumberFormat('en-US')
var usd = '$'
document.getElementById('rating_2').innerHTML=rating
...
if (price<0.01) { 
 ...
 usd.bold()+ (expo(price, 2)) }
  ...
  else { document.getElementById("price_2").innerHTML =    
  usd.bold()+ form2.format(tokenUS_fixed)}
...
document.getElementById("liquidity_2").innerHTML =  usd.bold()+  liq_format

var mcap_fixed = parseFloat(mcap).toFixed(0)
var mcap_form= form2.format(mcap_fixed)

document.getElementById("MCAP_2").innerHTML =  usd.bold()+ mcap_form
var progress_html = document.querySelector("#rating_2")
console.log(progress_html)
if (rating>80){
  progress_html.style=`color:#036b18`
}
...
if (kyc==Verified){
 document.getElementById('kyc_3').innerHTML="<i class='fa fa-id-card' style='font-size: 25px;color:#DBAC04'></i>"
}
if (team ==doxxed){
...
var mcap=data_response.mcap
 ...
 var form2 = Intl.NumberFormat('en-US')
var usd = '$'
document.getElementById('rating_3').innerHTML=rating
...
if (price<0.01) { 
 ...
 usd.bold()+ (expo(price, 2)) }
  ...
  else { document.getElementById("price_3").innerHTML =    
  usd.bold()+ form2.format(tokenUS_fixed)}
...
document.getElementById("liquidity_3").innerHTML =  usd.bold()+  liq_format

var mcap_fixed = parseFloat(mcap).toFixed(0)
var mcap_form= form2.format(mcap_fixed)

document.getElementById("MCAP_3").innerHTML =  usd.bold()+ mcap_form
var progress_html = document.querySelector("#rating_3")
console.log(progress_html)
if (rating>80){
  progress_html.style=`color:#036b18`
}
...
if (kyc==Verified){
 document.getElementById('kyc_4').innerHTML="<i class='fa fa-id-card' style='font-size: 25px;color:#DBAC04'></i>"
}
if (team ==doxxed){
...
var mcap=data_response.mcap
 ...
 var form2 = Intl.NumberFormat('en-US')
var usd = '$'
document.getElementById('rating_4').innerHTML=rating
...
if (price<0.01) { 
 ...
 usd.bold()+ (expo(price, 2)) }
  ...
  else { document.getElementById("price_4").innerHTML =    
  usd.bold()+ form2.format(tokenUS_fixed)}
...
document.getElementById("liquidity_4").innerHTML =  usd.bold()+  liq_format

var mcap_fixed = parseFloat(mcap).toFixed(0)
var mcap_form= form2.format(mcap_fixed)

document.getElementById("MCAP_4").innerHTML =  usd.bold()+ mcap_form
var progress_html = document.querySelector("#rating_4")
console.log(progress_html)
if (rating>80){
  progress_html.style=`color:#036b18`
}
...
name_sort.addEventListener("click", function sortTable(){
{
  ...
  table = document.getElementById("table_home_test");
  switching = true;
