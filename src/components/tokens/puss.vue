   ...
   <div class = "content_token_page">
    ...
    <div class="row tokenPage" >
        <div class="column left" >
            ...
            <div id="puss_logo"> </div>
         
        </div>
        <div class="column middle" style="background-color:#005a68;">
           <div class="separator" style = "color:#dbac04" id="puss_separator"><a href=""><cryptoicon symbol="bnb" size="40" /></a> &nbsp;  &nbsp;<span id="text_title"></span></div>
          
            <p1 class = "desc" style = "color: white" id="puss_desc" > </p1>
            <br><div  id="puss_icons">
           <br > <a id='puss_telegram' href=""><i class="fa fa-telegram" style="font-size:clamp(24px, 2vw, 40px);color:#DBAC04"></i> </a>
           <a id="puss_whitepaper" href=""><i class="fa fa-file-text" style="font-size:clamp(24px, 2vw, 40px); color:#DBAC04"></i></a>
           <a id='puss_twitter' href=""><i class="fa fa-twitter" style="font-size:clamp(26px, 2.32vw, 42px); color:#DBAC04"></i></a>

            <a id="puss_site" href=""><i class="fa fa-chrome" style="font-size:clamp(24px, 2vw, 40px);color:#DBAC04"></i></a></div>
...
<p style="color:white;" class = "table-text">Listing Date</p></th>
    <td><p style="color:white;" class = "table-text" id="puss_listing"></p></td>
  </tr>
  <tr>
    <th><p style="color:white;" class = "table-text">Launch Date</p>	</th>
    <td><p style="color:white;" class = "table-text" id="puss_launch"></p></td>
  </tr>
  <tr>
    <th><p style="color:white;" class = "table-text">Token Type</p></th>
    <td><p style="color:white;" class = "table-text" id="puss_layer"></p></td>
  </tr>
  <tr>
    <th>
<p style="color:white;" class = "table-text">Contract</p></th>
    <td><p style="color:white;" class = "table-text-link" >   <a id="puss_contract" href="">BSC Scan</a></p></td>
...
<table  class = 'token_price' style="width:100%">
  <tr>
    <th  style="color: white;" id="puss_price"> </th>

   <td   style="color: white;"><p id="pussiUSD"></p></td>

  </tr >
  <tr >
    <th  style="color: white;" id="puss_bnb"></th>
    <td   style="color: white;"><p id="puss/BNB"></p></td>

  </tr>
      <th  style="color: white;" id="puss_mcap">Total MCAP </th>

   <td  style="color: white;"><p id="mcap_puss"></p></td>
  <tr >
  <th style="color:white">Daily Change</th>
  
  <td style="color:white" ><p id="puss_summary_val"></p></td>
 ...
 <tr>
  ...
  <tr>
   ...
   <td ><p  id = "puss_liq_val"></p></td>

  </tr>
   <tr>
    <th style="color: white;">ATH Price </th>
   <td ><p  id = "puss_ath_price"></p></td>
...
<div class = 'buyToken'>
        ...
        <div class="row_chart" >
          <div id="desc_long" >
          <h2  class="desc_title" id = "desc_title_puss" style=" "> </h2>
        <div class="text_paragraph_div"> <span id="what_is_project_puss" class="what_is_project"></span></div> 
        <div class="separator_paragraphs" style = "color:#dbac04" id="puss_separator"></div>
<h2 class="desc_title" id = "desc_title_token_puss" style=" "> </h2>

<div class="text_paragraph_div"><span id="what_is_token_puss" class="what_is_project"></span></div> 
<h2 class="desc_title" id = "desc_title_token_puss" style=" "> </h2>
<div class="separator_paragraphs" style = "color:#dbac04" id="puss_separator"></div>
<h2 class="desc_title" style=" ">Future Plans </h2>
<div class="text_paragraph_div"><span id="future_plans_puss" class="what_is_project" >d</span></div> 

        </div>
      <div class="column right4">  <div class = "column left_twitter" id="">
   
        <a class="twitter-timeline" id= 'twitter_puss_widget' data-height="400px"   data-width="300px" data-theme="dark" href="">
      </a>
        </div>
        <div class="column right2">  <div id="pancake_swap_buy" >
<h2>Buy Now:</h2>
...
var contractaddress = "0xdd823661c23bcfcda52169836dcc1ca90ad14e36";
    ...
    props: ["id"],
     data() { 
      ...
      return {
        ...
        utility:'L3' ,
        team:'Undoxxed',
        wallettAddressRating:'0xD6659EeDa55032e674905cC33b97C40cDBa2Cc8A',
        name: 'puss Finance',
        symbol: 'puss',
       
        contractaddress: '0xdd823661c23bcfcda52169836dcc1ca90ad14e36', }
    },
...
const supply= (listing_data.supply)
  const what_is_project = (listing_data.what_is_project)
const what_is_token= (listing_data.what_is_token)
  const future_plans = listing_data.future_plans
 
document.getElementById('puss_separator').href= bscscan
document.getElementById('text_title').innerHTML= name
document.getElementById('puss_price').innerHTML = symbol
document.getElementById('puss_bnb').innerHTML = symbol+'/BNB'
document.getElementById('puss_desc').innerHTML = desc
document.getElementById('puss_launch').innerHTML = launch_date
document.getElementById('puss_layer').innerHTML = utility
document.getElementById('puss_listing').innerHTML = date
document.getElementById('puss_whitepaper').href = whitepaper
document.getElementById('puss_site').href = website
document.getElementById('puss_twitter').href = twitter
document.getElementById('puss_telegram').href = telegram
document.getElementById('puss_contract').href = bscscan
document.getElementById("desc_title_puss").innerHTML="What is"+"&hairsp; "+name+"?"
document.getElementById('what_is_project_puss').innerHTML = what_is_project
document.getElementById('what_is_token_puss').innerHTML = what_is_token
document.getElementById("desc_title_token_puss").innerHTML="What Does"+"&hairsp; $"+symbol+"&hairsp; "+" do?"
document.getElementById("future_plans_puss").innerHTML= future_plans
document.getElementById("twitter_puss_widget").href=twitter
var img = document.createElement("img");
img.id='logo'
img.src = logo_link_api;
var src = document.getElementById("puss_logo");
src.appendChild(img);

const banner_bottom_right = await axios.get( 'https://www.api.bscspotter.com/promoted_banner/token_page_bottom_right')

const banner_data_right = banner_bottom_right.data
console.log(banner_data_right)
if (banner_data_right.length>0){
  const banner_photo= banner_data[0].banner
  const website = banner_data[0].website
document.getElementById("banner_ad_bottom_right").innerHTML=' <img src="'+banner_photo+'" alt="banner_right" width="300" height="100">'
const right_ad = document.getElementById('banner_ad_bottom_right')
right_ad.addEventListener("click", function() {
  window.open(website)

})
}
const banner_data_graph = await axios.get( 'https://www.api.bscspotter.com/promoted_banner/token_page_top_under_graph')
if (banner_data_graph.length>0){
  const banner_photo= banner_data_graph[0].banner
  const website = banner_data_graph[0].website
document.getElementById("banner_under_graph").innerHTML=' <img src="'+banner_photo+'" alt="banner_graph" width="500" height="120">'
const right_ad = document.getElementById('banner_under_graph')
right_ad.addEventListener("click", function() {
  window.open(website)
...
const token_buy = document.getElementById("pancake_swap_href")


token_buy.href=('https://pancakeswap.finance/swap?outputCurrency='+contractaddress)
...
const acs = await axios.get(
                    ...
                    document.getElementById("puss/BNB").innerHTML =acs_value
...
if (TokenUS<0.01) { 
  ...
  function expo(x, f) {
   ...
   document.getElementById("pussiUSD").innerHTML =    
 usd.bold()+ (expo(TokenUS, 2)) }
  
  else { document.getElementById("pussiUSD").innerHTML =    
...
document.getElementById("mcap_puss").innerHTML =  usd.bold()+ mcap_form
...
document.getElementById("puss_liq_val").innerHTML = await usd.bold()+  liq_format
  ...
  var percent = "%"
    if (ath_usd<0.01){
        function expo(x, f) {
          ...
          document.getElementById("puss_ath_price").innerHTML = await (usd.bold()+final_ath)
    }else{let final_ath= (    
...
document.getElementById("puss_summary_val").innerHTML = await percent_fixed
if (percent_change<0){
   document.getElementById("puss_summary_val").style.color = "#EA3943"
  ...
  document.getElementById("puss_summary_val").innerHTML = "0"+percent
}
...
setTimeout(() => {
  ...
  var percent_change = document.getElementById('puss_summary_val').innerHTML
...
<style scoped> 
#pancake_swap_buy, #banner_ad_bottom_right{
  cursor: pointer
}
...
.separator_paragraphs::before,
.separator_paragraphs::after {
  content: '';
  flex: 1;
  border-bottom: 1px solid #ddd;
}

.separator_paragraphs:not(:empty)::before {
  margin-right: .25em;
}

.separator_paragraphs:not(:empty)::after {
  margin-left: .25em;
}
.separator_paragraphs::before,
.separator_paragraphs::after {
...
background-image:linear-gradient(315deg, #537895 8%, #09203f 57%);
 border-radius: 15px; 
 line-height: 300%;
