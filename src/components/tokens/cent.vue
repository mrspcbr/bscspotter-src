<template>
    ...
    <div class = "content_token_page">
     ...
     <div class="row tokenPage" >
         <div class="column left" >
             ...
             <div id="cent_logo"> </div>
          
         </div>
         <div class="column middle" style="background-color:#005a68;">
            <div class="separator" style = "color:#dbac04" id="cent_separator"><a href=""><cryptoicon symbol="bnb" size="40" /></a> &nbsp;  &nbsp;<span id="text_title"></span></div>
           
             <p1 class = "desc" style = "color: white" id="cent_desc" > </p1>
             <br><div  id="cent_icons">
            <br > <a id='cent_telegram' href=""><i class="fa fa-telegram" style="font-size:clamp(24px, 2vw, 40px);color:#DBAC04"></i> </a>
            <a id="cent_whitepaper" href=""><i class="fa fa-file-text" style="font-size:clamp(24px, 2vw, 40px); color:#DBAC04"></i></a>
            <a id='cent_twitter' href=""><i class="fa fa-twitter" style="font-size:clamp(26px, 2.32vw, 42px); color:#DBAC04"></i></a>
 
             <a id="cent_site" href=""><i class="fa fa-chrome" style="font-size:clamp(24px, 2vw, 40px);color:#DBAC04"></i></a></div>
 ...
 <p style="color:white;" class = "table-text">Listing Date</p></th>
     <td><p style="color:white;" class = "table-text" id="cent_listing"></p></td>
   </tr>
   <tr>
     <th><p style="color:white;" class = "table-text">Launch Date</p>	</th>
     <td><p style="color:white;" class = "table-text" id="cent_launch"></p></td>
   </tr>
   <tr>
     <th><p style="color:white;" class = "table-text">Token Type</p></th>
     <td><p style="color:white;" class = "table-text" id="cent_layer"></p></td>
   </tr>
   <tr>
     <th>
 <p style="color:white;" class = "table-text">Contract</p></th>
     <td><p style="color:white;" class = "table-text-link" >   <a id="cent_contract" href="">BSC Scan</a></p></td>
   ...
   <div class="row_chart" >
         <div class="column left2" id="cent_graph" >
              <TVChartContainer  :symbol="'BITQUERY'" :interval="'60'" :contractAddress="'0xae4d7b8e83bacc7469615565aa0b5030f01334b5'"></TVChartContainer>
         </div>
 ...
 <table  class = 'token_price' style="width:100%">
   <tr>
     <th  style="color: white;" id="cent_price"> </th>
 
    <td   style="color: white;"><p id="centiUSD"></p></td>
 
   </tr >
   <tr >
     <th  style="color: white;" id="cent_bnb"></th>
     <td   style="color: white;"><p id="cent/BNB"></p></td>
 
   </tr>
       <th  style="color: white;" id="cent_mcap">Total MCAP </th>
 
    <td  style="color: white;"><p id="mcap_cent"></p></td>
   <tr >
   <th style="color:white">Daily Change</th>
   
   <td style="color:white" ><p id="cent_summary_val"></p></td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td ><p  id = "cent_liq_val"></p></td>
 
   </tr>
    <tr>
     <th style="color: white;">ATH Price </th>
    <td ><p  id = "cent_ath_price"></p></td>
 ...
 var contractaddress = "0xae4d7b8e83bacc7469615565aa0b5030f01334b5";
     ...
     props: ["id"],
      data() { 
       ...
       return {
         ...
         utility:'L3' ,
         team:'Undoxxed',
         wallettAddressRating:'0xd41b1a291fab06dc87648c292268a4cb9d0b7b59',
         name: 'cent Finance',
         symbol: 'cent',
        
         contractaddress: '0xae4d7b8e83bacc7469615565aa0b5030f01334b5', }
     },
 ...
 document.getElementById('cent_separator').href= bscscan
 document.getElementById('text_title').innerHTML= name
 document.getElementById('cent_price').innerHTML = symbol
 document.getElementById('cent_bnb').innerHTML = symbol+'/BNB'
 document.getElementById('cent_desc').innerHTML = desc
 document.getElementById('cent_launch').innerHTML = launch_date
 document.getElementById('cent_layer').innerHTML = utility
 document.getElementById('cent_listing').innerHTML = date
 document.getElementById('cent_whitepaper').href = whitepaper
 document.getElementById('cent_site').href = website
 document.getElementById('cent_twitter').href = twitter
 document.getElementById('cent_telegram').href = telegram
 document.getElementById('cent_contract').href = bscscan
 
 var img = document.createElement("img");
 img.id='logo'
 img.src = logo_link_api;
 var src = document.getElementById("cent_logo");
 src.appendChild(img);
 ...
 const acs = await axios.get(
                     ...
                     document.getElementById("cent/BNB").innerHTML =acs_value
 ...
 if (TokenUS<0.01) { 
   ...
   function expo(x, f) {
    ...
    document.getElementById("centiUSD").innerHTML =    
  usd.bold()+ (expo(TokenUS, 2)) }
   
   else { document.getElementById("centiUSD").innerHTML =    
 ...
 document.getElementById("mcap_cent").innerHTML =  usd.bold()+ mcap_form
 ...
 document.getElementById("cent_liq_val").innerHTML = await usd.bold()+  liq_format
   ...
   var percent = "%"
     if (ath_usd<0.01){
         function expo(x, f) {
           ...
           document.getElementById("cent_ath_price").innerHTML = await (usd.bold()+final_ath)
     }else{let final_ath= (    
 ...
 document.getElementById("cent_summary_val").innerHTML = await percent_fixed
 if (percent_change<0){
    document.getElementById("cent_summary_val").style.color = "#EA3943"
   ...
   document.getElementById("cent_summary_val").innerHTML = "0"+percent
 }
 ...
 setTimeout(() => {
   ...
   var percent_change = document.getElementById('cent_summary_val').innerHTML
