<template>
    ...
    <div class = "content_token_page">
     ...
     <div class="row tokenPage" >
         <div class="column left" >
             ...
             <div id="forge_logo"> </div>
          
         </div>
         <div class="column middle" style="background-color:#005a68;">
            <div class="separator" style = "color:#dbac04" id="forge_separator"><a href=""><cryptoicon symbol="bnb" size="40" /></a> &nbsp;  &nbsp;<span id="text_title"></span></div>
           
             <p1 class = "desc" style = "color: white" id="forge_desc" > </p1>
             <br><div  id="forge_icons">
            <br > <a id='forge_telegram' href=""><i class="fa fa-telegram" style="font-size:clamp(24px, 2vw, 40px);color:#DBAC04"></i> </a>
            <a id="forge_whitepaper" href=""><i class="fa fa-file-text" style="font-size:clamp(24px, 2vw, 40px); color:#DBAC04"></i></a>
            <a id='forge_twitter' href=""><i class="fa fa-twitter" style="font-size:clamp(26px, 2.32vw, 42px); color:#DBAC04"></i></a>
 
             <a id="forge_site" href=""><i class="fa fa-chrome" style="font-size:clamp(24px, 2vw, 40px);color:#DBAC04"></i></a></div>
 ...
 <p style="color:white;" class = "table-text">Listing Date</p></th>
     <td><p style="color:white;" class = "table-text" id="forge_listing"></p></td>
   </tr>
   <tr>
     <th><p style="color:white;" class = "table-text">Launch Date</p>	</th>
     <td><p style="color:white;" class = "table-text" id="forge_launch"></p></td>
   </tr>
   <tr>
     <th><p style="color:white;" class = "table-text">Token Type</p></th>
     <td><p style="color:white;" class = "table-text" id="forge_layer"></p></td>
   </tr>
   <tr>
     <th>
 <p style="color:white;" class = "table-text">Contract</p></th>
     <td><p style="color:white;" class = "table-text-link" >   <a id="forge_contract" href="">BSC Scan</a></p></td>
   ...
   <div class="row_chart" >
         <div class="column left2" id="forge_graph" >
              <TVChartContainer  :symbol="'BITQUERY'" :interval="'60'" :contractAddress="'0x5138868ed1814be113227b8c6025cdc46d9d1d16'"></TVChartContainer>
         </div>
 ...
 <table  class = 'token_price' style="width:100%">
   <tr>
     <th  style="color: white;" id="forge_price"> </th>
 
    <td   style="color: white;"><p id="forgeiUSD"></p></td>
 
   </tr >
   <tr >
     <th  style="color: white;" id="forge_bnb"></th>
     <td   style="color: white;"><p id="forge/BNB"></p></td>
 
   </tr>
       <th  style="color: white;" id="forge_mcap">Total MCAP </th>
 
    <td  style="color: white;"><p id="mcap_forge"></p></td>
   <tr >
   <th style="color:white">Daily Change</th>
   
   <td style="color:white" ><p id="forge_summary_val"></p></td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td ><p  id = "forge_liq_val"></p></td>
 
   </tr>
    <tr>
     <th style="color: white;">ATH Price </th>
    <td ><p  id = "forge_ath_price"></p></td>
 ...
 var contractaddress = "0x5138868ed1814be113227b8c6025cdc46d9d1d16";
     ...
     props: ["id"],
      data() { 
       ...
       return {
         ...
         utility:'L3' ,
         team:'Undoxxed',
         wallettAddressRating:'0xd92A1F9d2EE57C8482629aAe314a0412E778AE54',
         name: 'forge Finance',
         symbol: 'forge',
 ...
 document.getElementById('forge_separator').href= bscscan
 document.getElementById('text_title').innerHTML= name
 document.getElementById('forge_price').innerHTML = symbol
 document.getElementById('forge_bnb').innerHTML = symbol+'/BNB'
 document.getElementById('forge_desc').innerHTML = desc
 document.getElementById('forge_launch').innerHTML = launch_date
 document.getElementById('forge_layer').innerHTML = utility
 document.getElementById('forge_listing').innerHTML = date
 document.getElementById('forge_whitepaper').href = whitepaper
 document.getElementById('forge_site').href = website
 document.getElementById('forge_twitter').href = twitter
 document.getElementById('forge_telegram').href = telegram
 document.getElementById('forge_contract').href = bscscan
 
 var img = document.createElement("img");
 img.id='logo'
 img.src = logo_link_api;
 var src = document.getElementById("forge_logo");
 src.appendChild(img);
 ...
 const acs = await axios.get(
                     ...
                     document.getElementById("forge/BNB").innerHTML =acs_value
 ...
 if (TokenUS<0.01) { 
   ...
   function expo(x, f) {
    ...
    document.getElementById("forgeiUSD").innerHTML =    
  usd.bold()+ (expo(TokenUS, 2)) }
   
   else { document.getElementById("forgeiUSD").innerHTML =    
 ...
 document.getElementById("mcap_forge").innerHTML =  usd.bold()+ mcap_form
 ...
 document.getElementById("forge_liq_val").innerHTML = await usd.bold()+  liq_format
   ...
   var percent = "%"
     if (ath_usd<0.01){
         function expo(x, f) {
           ...
           document.getElementById("forge_ath_price").innerHTML = await (usd.bold()+final_ath)
     }else{let final_ath= (    
 ...
 document.getElementById("forge_summary_val").innerHTML = await percent_fixed
 if (percent_change<0){
    document.getElementById("forge_summary_val").style.color = "#EA3943"
   ...
   document.getElementById("forge_summary_val").innerHTML = "0"+percent
 }
 ...
 setTimeout(() => {
   ...
   var percent_change = document.getElementById('forge_summary_val').innerHTML
